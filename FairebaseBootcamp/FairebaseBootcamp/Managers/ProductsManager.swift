...
final class ProductsManager {
    ...
    ///📌 Sort by Category or Price or both at the same time
    func getAllProducts(forCategory category: String?, forPrice descending: Bool?) async throws -> [Product] {//, count: Int, lastDocument: DocumentSnapshot?) async throws ->  (products: [Product], lastDocument: DocumentSnapshot?) {
...
//
//    ///📌 Sort by Category or Price or both at the same time
//    func getFilteredProducts(forCategory category: String?, forPrice descending: Bool?, count: Int, lastDocument: DocumentSnapshot?) async throws -> (products: [Product], lastDocument: DocumentSnapshot?) {
//
//        ///🔥 if let descending = descending and category = category (long form)
//        ///🔥 For combine filters need add  -> query index  (composite) (in cancel get address where add in firestore )
//
